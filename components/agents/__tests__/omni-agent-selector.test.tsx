...
describe("OmniAgentSelector", () => {
  ...
  describe("Rendering", () => {
    ...
    it("hides search input by default", () => {
      render(<OmniAgentSelector agents={mockAgents} onSelectAgent={vi.fn()} />);
  ...
  describe("Props and Configuration", () => {
    it("passes custom className", () => {
      ...
      expect(screen.getByTestId("omni-agent-selector")).toHaveClass(
        "custom-class",
      );
    });

    it("handles empty agents array", () => {
      render(<OmniAgentSelector agents={[]} onSelectAgent={vi.fn()} />);
  ...
  describe("Confirmation Dialog", () => {
    ...
    it("accepts showConfirmDialog prop", () => {
      render(
        <OmniAgentSelector
          agents={mockAgents}
          onSelectAgent={vi.fn()}
    ...
    it("dialog is not shown until OmniAI selection with query", () => {
      render(
        <OmniAgentSelector
          agents={mockAgents}
          onSelectAgent={vi.fn()}
