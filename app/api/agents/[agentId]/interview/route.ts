...
const InterviewRequestSchema = z.object({
  sessionId: z
    .string()
    .optional()
    .describe("Existing session ID to continue, or omit to start new"),
  answer: z
    .string()
    .optional()
    .describe("Answer to the current question (required if continuing)"),
  skipQuestion: z
    .boolean()
    .optional()
    .default(false)
    .describe("Skip current optional question"),
});
    ...
    steps: [
      {
        ...
        description:
          "This helps us tailor the analysis to your specific context.",
        type: "select",
        options: [
      ...
      },
      {
        ...
        description:
          "Understanding your users helps us evaluate the UX appropriately.",
        type: "textarea",
        placeholder:
          "e.g., Small business owners aged 30-50, tech-savvy consumers...",
        required: true,
      ...
      },
      {
        ...
        description:
          "This focuses our analysis on the most important user flow.",
        type: "textarea",
        placeholder:
          "e.g., Complete a purchase, find contact information, sign up for a service...",
        required: true,
        validation: { minLength: 10, maxLength: 500 },
      },
      {
        ...
        type: "textarea",
        placeholder:
          "e.g., High cart abandonment, low signup conversions, confusing navigation...",
        required: false,
    ...
    steps: [
      ...
      },
      {
        ...
        options: [
          {
            value: "party-a",
            label: "The party drafting/proposing the contract",
          },
          {
            value: "party-b",
            label: "The party receiving/reviewing the contract",
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            value: "critical",
            label: "Critical (over $1M or strategic importance)",
          },
        ],
        required: false,
      },
      {
        ...
        question:
          "Are there specific clauses or concerns you want us to focus on?",
        type: "textarea",
        placeholder:
          "e.g., Liability limitations, IP ownership, termination rights...",
        required: false,
        validation: { maxLength: 1000 },
      },
    ],
  ...
  "finance-planner": {
    ...
    steps: [
      ...
      },
      {
        ...
        type: "textarea",
        placeholder:
          "e.g., Save for a house down payment, retire by 55, pay off student loans...",
        required: true,
        validation: { minLength: 10, maxLength: 500 },
      },
      {
      ...
      },
      {
        ...
        options: [
          ...
          {
            value: "aggressive",
            label: "Aggressive - Accept higher risk for potential returns",
          },
        ],
        required: false,
      },
...
export async function POST(
  ...
  const log = logger.child({
    route: "/api/agents/[agentId]/interview",
    method: "POST",
  });
  ...
  try {
    ...
    const principal = buildPrincipalFromSession(authSession, []);
    const decision = cedar.isAuthorized({
      principal,
      action: { type: "Action", id: "InterviewAgent" },
        ...
        if (skipQuestion) {
          ...
          if (currentStep.validation) {
            if (
              ...
              answer.length < currentStep.validation.minLength
            ) {
              return NextResponse.json(
                {
            ...
            if (
              ...
              answer.length > currentStep.validation.maxLength
            ) {
              return NextResponse.json(
                {
